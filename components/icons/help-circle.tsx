...
function HelpCircleIcon(props: SVGAttributes<SVGSVGElement>) {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g clip-path="url(#clip0_3922_4885)">
        <path
        ...
        <path
          ...
          stroke-linejoin="round"
        />
        <path d="M10 14.1665H10.0083" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
        <clipPath id="clip0_3922_4885">
